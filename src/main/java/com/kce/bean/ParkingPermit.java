...
public class ParkingPermit {
    ...
    public PermitHolder getPermitHolder() { return permitHolder; }
    public void setPermitHolder(PermitHolder permitHolder) { this.permitHolder = permitHolder; }
    ...
    public Date getPermitStartDate() { return permitStartDate; }
    public void setPermitStartDate(Date permitStartDate) { this.permitStartDate = permitStartDate; }

    public Date getPermitEndDate() { return permitEndDate; }
    public void setPermitEndDate(Date permitEndDate) { this.permitEndDate = permitEndDate; }

    public String getPermitStatus() { return permitStatus; }
    public void setPermitStatus(String permitStatus) { this.permitStatus = permitStatus; }

    public int getViolationCount() { return violationCount; }
    public void setViolationCount(int violationCount) { this.violationCount = violationCount; }

    public BigDecimal getOutstandingFineAmount() { return outstandingFineAmount; }
    public void setOutstandingFineAmount(BigDecimal outstandingFineAmount) { this.outstandingFineAmount = outstandingFineAmount; }
}